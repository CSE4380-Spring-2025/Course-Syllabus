...
\begin{center}
{\bf CSE 4380.010 / 5380.010 Information Systems \linebreak{} Spring 2025\linebreak{} \ \
}
\end{center}
...
\vskip.25in
 ...
 \vskip.25in
\noindent\textbf{Section Information:} CSE4380 Section 010
 \vskip.25in
\noindent\textbf{Lab Information:} Section 011 ERB 106 Mon 1:00pm - 3:50pm  \\\\
\noindent\textbf{Lab Information:} Section 012 ERB 106 Wed 1:00pm - 3:50pm  \\\\
\noindent\textbf{Lab Information:} Section 013 ERB 106 Tue 1:00pm - 3:50pm  \\\\
 \vskip.25in
\noindent\textbf{Time and Place of Class Meetings}:  Fri 1:00PM - 3:50 PM SWSH 104
\vskip.25in
\noindent\textbf{Textbook:}  Computer Security: Principles and Practices by William Stallings and Lawrie Brown (3rd edition) ISBN-13: 978-0133773922, ISBN-10: 0133773922 
\vskip.25in
\noindent\textbf{Course Website}: https://www.cse4380.org
\vskip.25in
\noindent\textbf{Course Slack Channel}:\\\\
https://join.slack.com/t/cse4380/shared\_invite/zt-2xm3239np-nekxrPyJrCQfUiLMSTfcQA
...
This is the hands-on introduction to the basics of security for upper-level undergraduate students and graduate students. Includes system security, buffer overflows, a high-level overview of cryptography, firewalls and intrusion detection/prevention, malware, penetration testing, forensics, and system administration.
\vskip.25in
\noindent\textbf{Student Learning Outcomes:}
Upon successful completion of this course, students will be able to:
\begin{enumerate}
\item Use cryptographic primitives directly in order to understand their respective uses and how they work together to provide security.
\item Develop simple malware in order to understand hooking and how hooking can be subverted for malicious purposes.
\item Set up and use defensive and security testing technologies in the network and operating system in order to see how they defend against attacks.
\item Exploit software vulnerabilities in order to understand how they work and how defenses could stop them.
\item Study a range of concepts to gain a broad understanding of the field of information security.
\item Apply class knowledge in a capture-the-flag simulation exercise at the end of the semester.
\end{enumerate}
\vskip.25in
\noindent\textbf{Descriptions of major assignments}: There will be one midterm exam, a final exam and a semester project.  There will also be 5 labs and pre-labs.  The final exam date is set by the university and is non-negotiable.
\vskip.25in
%\pagebreak
...
Exam 1 \dotfill Mar. 7th (tentative)\\
Final  \dotfill May 2nd 11:00am - 1:30pm (fixed)\\
\end{flushleft}
\end{minipage}
\end{center}
\pagebreak
\vskip.25in
\noindent\textbf{Undergraduate (4380) Grading Policy}: Grades are based on the following:
\begin{table}[h]
\begin{tabular}{|l|l|lll}
\cline{1-2}
Project & 25\% &  &  &  \\ \cline{1-2}
Labs (Prelabs 2\% Labs 5\%) & 25\% &  &  &  \\ \cline{1-2}
Exam 1 & 25\% &  &  &  \\ \cline{1-2}
...
\vskip.50in
\noindent\textbf{Graduate (5380) Grading Policy}: Grades are based on the following:
\begin{table}[h]
\begin{tabular}{|l|l|lll}
\cline{1-2}
Project & 25\% &  &  &  \\ \cline{1-2}
Labs (Prelabs 2\% Labs 5\%) & 25\% &  &  &  \\ \cline{1-2}
Exam 1 & 15\% &  &  &  \\ \cline{1-2}
Final Exam & 15\% &  &  &  \\ \cline{1-2}
Paper and Presentation & 20\% &  &  &  \\ \cline{1-2}
\end{tabular}
\end{table}
...
\vskip.25in
\noindent\textbf{Lab Attendance and Completion}: Attendance to your assigned lab section during lab weeks is mandatory. You are expected to come to the lab having completed a pre-lab assignment that the GTA will check before you may begin the lab. No make-up lab except for illness or personal emergency. A written explanation must be submitted to your instructor at least one day before your assigned lab time.
...
\includegraphics[scale=.4]{source/010/evacuation.png} 
...
\center{
\includegraphics[scale=0.35]{source/010/schedule.png} 
}
\end{document}
