...
\end{enumerate}
\vskip.25in
\noindent\textbf{Descriptions of major assignments}: There will be one exam.  There will also be 5 labs and pre-labs.  The final exam date is set by the university and is non-negotiable.
\vskip.25in
%\pagebreak
