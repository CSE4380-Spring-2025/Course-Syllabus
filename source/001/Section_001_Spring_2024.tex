...
\begin{center}
{\bf CSE 4380.001/5380.001 Information Systems \linebreak{} Spring 2024\linebreak{} \ \
}
\end{center}
...
\vskip.25in
\noindent\textbf{Office Hours:} Friday 1:00PM - 4:00PM 
\vskip.25in
...
This is a hands-on introduction to the basics of security for upper-level undergraduate students and graduate students. Includes system security, buffer overflows, a high-level overview of cryptography, firewalls and intrusion detection/prevention, malware, penetration testing, forensics, and system administration.

\vskip.25in
\noindent\textbf{Student Learning Outcomes:}
 Use cryptographic primitives directly to understand their respective uses and how they work
together to provide security.
\begin{itemize}
\item Develop simple malware to understand how hooking can be subverted for malicious purposes.
\item Set up and use defensive and security testing technologies in the network and operating
system to see how they defend against attacks.
\item Exploit software vulnerabilities to understand how they work and how defenses could stop
them.
\item Study a range of concepts to gain a broad understanding of information security.
\item Apply class knowledge in a capture-the-flag simulation exercise at the end of the semester.
\end{itemize}
\vskip.25in
\noindent\textbf{Descriptions of major assignments}: There will be two exams.  There will also be 5 labs and pre-labs.  Students in CSE 5380 will be required to survey current exploits and write a paper and present their results.   All dates will be posted in advance on the course Canvas site.  The final exam date is set by the university and is non-negotiable.
\vskip.25in
%\pagebreak
...
Exam 1 \dotfill Mar. 8th (tentative)\\
Final  \dotfill May 3rd  8:00 a.m. – 10:30 a.m. (fixed)\\
\end{flushleft}
\end{minipage}
\end{center}
\vskip.25in
